                        ...
                        <div className="relative mx-auto max-w-[500px] overflow-hidden rounded-lg bg-white py-9 text-center sm:px-12 md:px-[60px]">
                            ...
                            <form onSubmit={handleQuestion}>
                                <div className="mb-4">
                                    ...
                                    />
                                    {errors.question && <div className="flex">
                                        <span className="text-red-400 text-sm">*{errors.question[0]}</span>
                                    </div>}
                                </div>
                                <div className="mb-4">
                                ...
                                {question_type === 'True/False' && (
                                    <div className="mb-4">
                                        <p className="text-left text-sm font-medium text-slate-700">True/False</p>
                                        <div>
                                            <label className="inline-flex items-center">
                                                <input type="radio" value='True'
                                            onChange={(e) => setTrueFalse(e.target.value)} className="form-radio" />
                                            ...
                                            {errors.true_false && <div className="flex">
                                                <span className="text-red-400 text-sm">*{errors.true_false[0]}</span>
                                            </div>}
                                    </div>
                                )}
                                {question_type === 'Text Field' && (
                                    <div className="mb-4">
                                        <textarea
                                            ...
                                            className="border-[#E9EDF4] w-full rounded-md border bg-[#FCFDFE] py-3 px-5 text-base text-body-color placeholder-[#ACB6BE] outline-none focus:border-primary focus-visible:shadow-none"
                                        />
                                        {errors.text_field && <div className="flex">
                                            <span className="text-red-400 text-sm">*{errors.text_field}</span>
                                        </div>}
                                    </div>
                                )}
                                ...
                                {question_type === 'MCQs' && (
                                    <div className="mb-4">
                                        <p className="text-left text-sm font-medium text-slate-700">Options</p>
                                        {options.map((option, index) => (
                                            <div key={option.id} className="flex items-center mb-2">
                                                ...
                                                {errors.options && errors.options[option.id] && (
                                                    <span className="text-red-400 text-sm ml-2">{errors.options[option.id]}</span>
                                                )}
                                            </div>
                                        ))}
